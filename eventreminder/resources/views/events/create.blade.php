...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow">
    ...
    <form method="POST" action="{{ route('events.store') }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="title" value="{{ old('title') }}" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" required>
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <input type="datetime-local" name="start_date" 
                       value="{{ old('start_date', isset($date) ? $date . 'T09:00' : '') }}" 
            ...
            <div>
                ...
                <input type="datetime-local" name="end_date" 
                       value="{{ old('end_date', isset($date) ? $date . 'T10:00' : '') }}" 
                       class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:border-blue-500" required>
            ...
            <div class="flex gap-2">
                @foreach(['#3B82F6', '#EF4444', '#10B981', '#F59E0B', '#8B5CF6', '#EC4899'] as $color)
                    <label class="flex items-center">
                        <input type="radio" name="color" value="{{ $color }}" {{ old('color', '#3B82F6') == $color ? 'checked' : '' }} class="mr-2">
        ...
        <div class="flex gap-4">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">Simpan Event</button>
